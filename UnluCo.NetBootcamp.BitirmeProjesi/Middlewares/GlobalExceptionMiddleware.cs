...
namespace UnluCo.NetBootcamp.BitirmeProjesi.Middlewares
{
    public class GlobalExceptionMiddleware
    {
        ...
        private Task HandleExeption(HttpContext context, Exception ex, Stopwatch watch)
        {
            ...
            //var result = JsonConvert.SerializeObject(new { error = ex.Message }, Formatting.None);//donus formatini json olarak verir
            var result = JsonConvert.SerializeObject(new ResultModel {Message = ex.Message });
